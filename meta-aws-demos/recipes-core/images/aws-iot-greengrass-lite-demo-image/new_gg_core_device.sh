...
wic rm tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/device.pem.crt 
wic cp $NEW_GG_CORE_DEVICE/device.pem.crt tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/
wic rm tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/private.pem.key
wic cp $NEW_GG_CORE_DEVICE/private.pem.key tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/
wic rm tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/AmazonRootCA1.pem
wic cp $NEW_GG_CORE_DEVICE/AmazonRootCA1.pem tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/
wic rm tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/config.yaml
wic cp $NEW_GG_CORE_DEVICE/config.yaml tmp/deploy/images/\${MACHINE}/\${IMAGE}-\${MACHINE}.rootfs.ext4:1/etc/greengrass/
EOF
...
# wic cp does not overwrite
wic rm tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/device.pem.crt 
wic cp $NEW_GG_CORE_DEVICE/device.pem.crt  tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/
wic rm tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/private.pem.key
wic cp $NEW_GG_CORE_DEVICE/private.pem.key tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/
wic rm tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/AmazonRootCA1.pem
wic cp $NEW_GG_CORE_DEVICE/AmazonRootCA1.pem tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/
wic rm tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/config.yaml
wic cp $NEW_GG_CORE_DEVICE/config.yaml tmp/deploy/images/${MACHINE}/${IMAGE}-${MACHINE}.rpi-sdimg:2/etc/greengrass/
EOF
